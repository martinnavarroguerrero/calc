...
b0 = Button(master, text="0", command=lambda: calc.ctm(0),width=5) 
b1 = Button(master, text="1", command=lambda: calc.ctm(1),width=5) 
b2 = Button(master, text="2", command=lambda: calc.ctm(2),width=5) 
b3 = Button(master, text="3", command=lambda: calc.ctm(3),width=5) 
b4 = Button(master, text="4", command=lambda: calc.ctm(4),width=5) 
b5 = Button(master, text="5", command=lambda: calc.ctm(5),width=5) 
b6 = Button(master, text="6", command=lambda: calc.ctm(6),width=5) 
b7 = Button(master, text="7", command=lambda: calc.ctm(7),width=5) 
b8 = Button(master, text="8", command=lambda: calc.ctm(8),width=5) 
b9 = Button(master, text="9", command=lambda: calc.ctm(9),width=5) 
b_dot = Button(master, text=".", command=lambda: calc.ctm("."),width=5) 
...
divide = Button(master, text="/", command=lambda: calc.set_op(3),width=5) 
